package net.freelancertech.vaccation.web.rest;

import net.freelancertech.vaccation.MngtJobApp;
import net.freelancertech.vaccation.domain.Authority;
import net.freelancertech.vaccation.domain.PersistentToken;
import net.freelancertech.vaccation.domain.User;
import net.freelancertech.vaccation.repository.AuthorityRepository;
import net.freelancertech.vaccation.repository.PersistentTokenRepository;
import net.freelancertech.vaccation.repository.UserRepository;
import net.freelancertech.vaccation.security.AuthoritiesConstants;
import net.freelancertech.vaccation.service.MailService;
import net.freelancertech.vaccation.service.UserService;
import net.freelancertech.vaccation.service.dto.UserDTO;
import net.freelancertech.vaccation.web.rest.vm.KeyAndPasswordVM;
import net.freelancertech.vaccation.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MngtJobApp.class)
